-- 0025 · The two check-in/out stamp fields, on every container that holds a
-- catalogue.
--
-- 0024 inserted 'Checked-in At' / 'Checked-out At' only under the container of
...
-- database that 0024 already served unchanged.
